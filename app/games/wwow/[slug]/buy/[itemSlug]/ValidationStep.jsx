    ...
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-xs text-[var(--muted)] font-medium mt-1">Enter your Character ID and select server.</p>
        </div>
        {/* <HelpImagePopup /> */}
      </div>
        ...
        <div className="space-y-2">
          ...
          <div className="relative group">
            ...
            >
              ...
              <option value="os_asia">OS Asia</option>
              <option value="os_cht">OS CHT</option>
              <option value="os_euro">OS Euro</option>
              <option value="os_sea">OS SEA</option>
              <option value="os_usa">OS USA</option>
            </select>
          </div>
        </div>
      </div>
